...
for i in range(2):
    ...
    np.save('/rds/project/t2_vol3/rds-t2-cs105/Covid-19/dataAll_5_class/results/_original_inceptionv3_40_adam_train_'+str(i)+'.npy', hold_accuracy_train)
    np.save('/rds/project/t2_vol3/rds-t2-cs105/Covid-19/dataAll_5_class/results/_original_inceptionv3_40_adam_val_'+str(i)+'.npy', hold_accuracy_val)
    file_name = "/rds/project/t2_vol3/rds-t2-cs105/Covid-19/dataAll_5_class/models/inceptionv3"+str(i)+".params"
